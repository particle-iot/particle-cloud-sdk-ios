Pod::Spec.new do |s|
    ...
    s.description      = <<-DESC
                        Particle (formerly Particle) iOS Cloud SDK Cocoapod library
                        ...
                        DESC
    s.homepage         = "https://github.com/particle/particle-sdk-ios"
    s.screenshots      = "http://i59.tinypic.com/mrthqc.jpg"
    s.license          = 'Apache 2.0'
    s.author           = { "Particle" => "ido@particle.io" }
    s.source           = { :git => "https://github.com/particle/Particle-SDK-ios.git", :tag => s.version.to_s }
